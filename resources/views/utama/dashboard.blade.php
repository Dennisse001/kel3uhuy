...
<main>
    ...
    <div class="popular-items pt-50">
        <div class="container-fluid">
            <div class="row">
                @foreach ($tada->take(4) as $a)
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-popular-items mb-50 text-center wow fadeInUp" data-wow-duration="1s"
                        data-wow-delay=".1s">
                        <div class="popular-img">
                            <img src="{{ (!empty($a->cover)) ? asset('storage/kategori/' . $a->cover) : asset('upload/no_image.png') }}" alt="">
                            <div class="img-cap">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s"
                        data-wow-delay=".1s">
                        <div class="popular-img">
                            <img src="{{ (!empty($item->cover)) ? asset('storage/produk/' . $item->cover) : asset('upload/no_image.png') }}"
                                alt="">
                            <div class="favorit-items">
